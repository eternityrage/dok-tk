"""
Upload videos to VK (VKontakte) - DokTok Lens
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "DokTok Lens - Dakota Johnson Moments!\n\n#dakotajohnson #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'DokTok Lens Video',
